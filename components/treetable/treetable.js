...
var TreeTable = /** @class */ (function () {
    ...
    TreeTable.prototype.getScrollPosition = function () {
        return this.ttScrollableView ? this.ttScrollableView.getScrollPosition() : 0;
    };
    TreeTable.prototype.setScrollPosition = function (scrollPosition) {
        var scrollableViewComponent = this.ttScrollableView;
    ...
    __decorate([
        core_1.ViewChild('ttScrollableView', { static: false }),
        __metadata("design:type", TTScrollableView)
    ], TreeTable.prototype, "ttScrollableView", void 0);
    __decorate([
...
var TTScrollableView = /** @class */ (function () {
    ...
    TTScrollableView.prototype.getScrollPosition = function () {
        return this.scrollBodyViewChild.nativeElement.scrollTop;
    };
    TTScrollableView.prototype.setScrollPosition = function (scrollposition) {
